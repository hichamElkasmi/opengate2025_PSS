...
public class SSRepo_AccountsList implements SQLData {
	...
	private final String PROCEDURE_SQL = "getAccountsList";
	...
	public SSRepo_AccountsList(SSEnt_HeadInitCrdRq request) {
		this();
	         ...
	         .declareParameters(
		        ...
		        .declareParameters(
		            new SqlOutParameter(
		                ...
		                OracleTypes.STRUCT,
		                RESPONSE_TYPE,
		                new SqlReturnTypeData(SSRepo_AccountsList.class, auxiliaryTypes)));
		    
			Map in = Collections.singletonMap("v_request", this);
			response = ((SSRepo_AccountsList)jdbcCall.executeObject(SSRepo_AccountsList.class,in)).getResponse();

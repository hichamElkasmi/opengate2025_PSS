...
public class SSRepo_CustomerList implements SQLData {
	private final String SCHEMA_SQL = "OPENGATEV2";
    private final String PACKAGE_SQL = "opengate_card_management";
    private final String PROCEDURE_SQL = "customer_list";
    @Getter @Setter
    
    private SSEnt_CustomerListRq request;
    ...
    public SSRepo_CustomerList() {
        logr = new SS_LoggingImpl();
        logr.setClazz(getClass());
    }
 
    public SSRepo_CustomerList(SSEnt_CustomerListRq request) {
        this();

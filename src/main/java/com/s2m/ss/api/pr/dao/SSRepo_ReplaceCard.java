...
public class SSRepo_ReplaceCard implements SQLData {

	private final String REQUEST_TYPE = "REPLACECARDRQ";
	private final String RESPONSE_TYPE = "REPLACECARDRS";
	
	private final String PACKAGE_SQL = SSEnt_DF.PACKAGE_SQL;
	private final String PROCEDURE_SQL = "replaceCard";

	@Getter @Setter
	private SSEnt_ReplaceCardRq request;
	...
	public SSRepo_ReplaceCard(SSEnt_ReplaceCardRq request) {
		this();
	...
	public void writeSQL(SQLOutput stream) throws SQLException {
		...
		stream.writeObject(request.getReason());
	         ...
	         .declareParameters(
		        ...
		        .declareParameters(
		            new SqlOutParameter(
		                ...
		                OracleTypes.STRUCT,
		                RESPONSE_TYPE,
		                new SqlReturnTypeData(SSRepo_ReplaceCard.class, auxiliaryTypes)));
		    
			Map in = Collections.singletonMap("v_request", this);
			response = ((SSRepo_ReplaceCard)jdbcCall.executeObject(SSRepo_ReplaceCard.class,in)).getResponse();
